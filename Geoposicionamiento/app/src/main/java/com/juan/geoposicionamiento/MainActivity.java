package com.juan.geoposicionamiento;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 5- procesamos el metodo clic del boton
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (location != null) {
                    try {
                        ...
                        // Escribimos la localizacion n nuestra APP
                        tv1.setText(Html.fromHtml(
                                "<font color='6200EE'><b>Latitude: </b><br><font>" + direcciones.get(0).getLatitude()
                        ));
                        tv2.setText(Html.fromHtml(
                                "<font color='6200EE'><b>Longitud: </b><br><font>" + direcciones.get(0).getLongitude()
                        ));
                        // Podemos obtener el pais donde estamos
                        tv3.setText(Html.fromHtml(
                                "<font color='6200EE'><b>Pais: </b><br><font>" + direcciones.get(0).getCountryName()
                        ));
                        // Podemos obtener la localidad donde estamos
