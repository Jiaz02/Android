...
public class MyPreguntaRecyclerViewAdapter extends RecyclerView.Adapter<MyPreguntaRecyclerViewAdapter.ViewHolder> {
    ...
    @Override
    public com.juan.copscaps.modosdejuego.deadmatch.MyPreguntaRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        return new com.juan.copscaps.modosdejuego.deadmatch.MyPreguntaRecyclerViewAdapter.ViewHolder(FragmentPreguntaBinding.inflate(LayoutInflater.from(parent.getContext()),parent,false));

    }

    @Override
    public void onBindViewHolder(final com.juan.copscaps.modosdejuego.deadmatch.MyPreguntaRecyclerViewAdapter.ViewHolder holder, int position) {
